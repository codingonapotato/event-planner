...
shiftRouter.get('/browse/:type/:a1/:a2/:a3/:a4/:a5/:a6', async (req, res) => {
   const type:string =req.params.type;
   let arr:any[] =[req.params.a1,req.params.a2,req.params.a3,
      req.params.a4,req.params.a5,req.params.a6];
   if (type==='shift') arr.unshift('shift_id');
   if (type==='event') arr.unshift('event_id');
